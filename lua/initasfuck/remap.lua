...
-- conflicts on C-.. -- vim.keymap.set("n", "<C-k>", "<cmd>cnext<CR>zz")
-- conflicts on C-.. -- vim.keymap.set("n", "<C-j>", "<cmd>cprev<CR>zz")
-- conflicts on C-.. -- vim.keymap.set("n", "<leader>k", "<cmd>lnext<CR>zz")
-- conflicts on C-.. -- vim.keymap.set("n", "<leader>j", "<cmd>lprev<CR>zz")
